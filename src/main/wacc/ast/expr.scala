...
case object ArrayOrIdent extends ParserBridgePos2[Ident, OptionWrap[ListWrap[Expr]], ArrayOrIdent] {
    override def apply[String, Unit](i: Ident[String, Unit], exprs: Option[List[Expr[String, Unit]]])(pos: (Int, Int)): ArrayOrIdent[String, Unit] = exprs match {
...
case object Call extends ParserBridgePosType2[Ident, ListWrap[Expr], Call] {
...
case class IntLit[N, T](n: Int)(val pos: (Int, Int)) extends Expr[N, T]
case class BoolLit[N, T](b: Boolean)(val pos: (Int, Int)) extends Expr[N, T]
case class CharLit[N, T](c: Char)(val pos: (Int, Int)) extends Expr[N, T]
case class StrLit[N, T](s: String)(val pos: (Int, Int)) extends Expr[N, T]
